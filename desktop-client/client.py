...
def detect_eso_dir() -> Optional[str]:
    ...
    if system == "Windows":
        ...
        # Linux (e.g. via Steam/Proton)
        candidates = [
            home / ".steam" / "steam" / "steamapps" / "compatdata" / "306130" / "pfx" /
            "drive_c" / "users" / "steamuser" / "Documents" / "Elder Scrolls Online" / "live",
        ]
...
class SyncEngine:
    ...
    def push_outgoing(self):
        ...
        # Convert from Lua indexed table to list
        action_list = []
    ...
    def pull_incoming(self):
        ...
        for notif in notifications:
            ...
            incoming_data["ah_notifications"].append(notif)
